...
[![auditor-bundle 7.x CI](https://github.com/DamienHarper/auditor-bundle/actions/workflows/ci-7.x.yml/badge.svg)](https://github.com/DamienHarper/auditor-bundle/actions/workflows/ci-7.x.yml)
...
`auditor-bundle`, formerly known as `DoctrineAuditBundle` integrates `auditor` library into any Symfony 7.4+ application.
...
|:--------|:----------------------------|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 7.x     | Active development :rocket: | PHP >= 8.4, Symfony >= 7.4, Doctrine DBAL >= 4.0, Doctrine ORM >= 3.2   | [![auditor-bundle 7.x CI](https://github.com/DamienHarper/auditor-bundle/actions/workflows/ci-7.x.yml/badge.svg)](https://github.com/DamienHarper/auditor-bundle/actions/workflows/ci-7.x.yml) <br/>[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/DamienHarper/auditor-bundle/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/DamienHarper/auditor-bundle/?branch=master) <br/>[![codecov](https://codecov.io/gh/DamienHarper/auditor-bundle/branch/master/graph/badge.svg)](https://app.codecov.io/gh/DamienHarper/auditor-bundle/branch/master) |
| 6.x     | Active support              | PHP >= 8.2, Symfony >= 5.4                                              | [![auditor-bundle 6.x CI](https://github.com/DamienHarper/auditor-bundle/actions/workflows/ci-6.x.yml/badge.svg)](https://github.com/DamienHarper/auditor-bundle/actions/workflows/ci-6.x.yml) <br/>[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/DamienHarper/auditor-bundle/badges/quality-score.png?b=6.x)](https://scrutinizer-ci.com/g/DamienHarper/auditor-bundle/?branch=6.x) <br/>[![codecov](https://codecov.io/gh/DamienHarper/auditor-bundle/branch/6.x/graph/badge.svg)](https://app.codecov.io/gh/DamienHarper/auditor-bundle/branch/6.x)             |
| 5.x     | End of life                 | PHP >= 7.4, Symfony >= 4.4                                              | [![auditor-bundle 5.x CI](https://github.com/DamienHarper/auditor-bundle/actions/workflows/ci-5.x.yml/badge.svg)](https://github.com/DamienHarper/auditor-bundle/actions/workflows/ci-5.x.yml)                                                                                                                                                                                                                                                                                                                                                                                 |
...
See [UPGRADE-7.0.md](UPGRADE-7.0.md) for upgrade instructions from 6.x to 7.0.
