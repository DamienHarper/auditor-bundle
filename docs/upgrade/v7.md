...
`SecurityProvider` now uses `FirewallMapInterface` instead of `FirewallMap` for better autowiring compatibility. This is an internal change but may affect you if you were manually constructing this service.
